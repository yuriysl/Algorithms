...
namespace Algorithms.AlgorithmsTests.DynamicProgramming
{
	public class BitonicTourTests
	{
		...
		public void getMinTourTest0()
		{
			...
			int n = 7;
			var r = new int[n, n];
			var res = bitonicTour.GetMinTour(new double[] { 0, 1, 2, 5, 6, 7, 8 }, new double[] { 6, 0, 3, 4, 1, 5, 2 }, out r);
		...
		public void getMinTourTest1()
		{
			...
			int n = 7;
			var r = new int[n, n];
			var res = bitonicTour.GetMinTour(new double[] { 1, 2, 3, 4, 7 }, new double[] { 0, 8, 4, 2, 7 }, out r);
